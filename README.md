...
#### WordPress
- [wp-cli-move](https://github.com/nlemoine/wp-cli-move) ([v0.1.3](https://github.com/nlemoine/wp-cli-move/releases/tag/0.1.3) - 5 days ago) — Sync your WordPress content (database and uploads) between stages using the power of WP-CLI aliases.
- [wp-symfony-local-server](https://github.com/nlemoine/wp-symfony-local-server) ([v2.0.1](https://github.com/nlemoine/wp-symfony-local-server/releases/tag/v2.0.1) - 2 weeks ago) — A set a hooks to fix running WordPress on Symfony Local Server with local domain names
- [page-for-custom-post-type](https://github.com/nlemoine/page-for-custom-post-type) ([v1.1.0](https://github.com/nlemoine/page-for-custom-post-type/releases/tag/1.1.0) - 3 weeks ago) — WordPress plugin to set a page for any custom post type archive — just like the native "page for posts" setting.
...
#### PHP
- [http-cli](https://github.com/nlemoine/http-cli) ([v1.1.1](https://github.com/nlemoine/http-cli/releases/tag/1.1.1) - 6 days ago) — Serverless HTTP client - make requests to PHP scripts on the command line
- [dtcg-tokens](https://github.com/nlemoine/dtcg-tokens) ([v1.0.0](https://github.com/nlemoine/dtcg-tokens/releases/tag/1.0.0) - 6 days ago) — Read, resolve, and render DTCG design tokens at runtime in PHP, with optional Twig and Symfony bridges.
...
- [fix: force non-interactive ssh for db push, add unit tests](https://github.com/nlemoine/wp-cli-move/pull/11) on [nlemoine/wp-cli-move](https://github.com/nlemoine/wp-cli-move) — 5 days ago
- [fix: rsync uploads fail on openrsync ("empty remote host")](https://github.com/nlemoine/wp-cli-move/pull/10) on [nlemoine/wp-cli-move](https://github.com/nlemoine/wp-cli-move) — 5 days ago
- [Feat/vite plugin mjml](https://github.com/nlemoine/packages/pull/1) on [nlemoine/packages](https://github.com/nlemoine/packages) — 5 days ago
- [ci: adopt centralized reusable workflows](https://github.com/nlemoine/http-cli/pull/3) on [nlemoine/http-cli](https://github.com/nlemoine/http-cli) — 6 days ago
- [Use reusable release-please workflow](https://github.com/nlemoine/rangelog/pull/6) on [nlemoine/rangelog](https://github.com/nlemoine/rangelog) — 6 days ago
- [Pilot reusable php-qa workflow](https://github.com/nlemoine/rangelog/pull/5) on [nlemoine/rangelog](https://github.com/nlemoine/rangelog) — 6 days ago
- [test(image): fix flaky testReplacedImage caused by uploads leakage](https://github.com/timber/timber/pull/3275) on [timber/timber](https://github.com/timber/timber) — 1 week ago
- [ci: surface public API changes on pull requests](https://github.com/timber/timber/pull/3274) on [timber/timber](https://github.com/timber/timber) — 1 week ago
- [feat: support multisite installations](https://github.com/nlemoine/wp-cli-move/pull/8) on [nlemoine/wp-cli-move](https://github.com/nlemoine/wp-cli-move) — 2 weeks ago
- [Preserve transparency in the Imagick grayscale effect](https://github.com/php-imagine/Imagine/pull/880) on [php-imagine/Imagine](https://github.com/php-imagine/Imagine) — 3 weeks ago
- [Fix imagick stale layers](https://github.com/php-imagine/Imagine/pull/879) on [php-imagine/Imagine](https://github.com/php-imagine/Imagine) — 3 weeks ago
...
- [Improve Yoast SEO integration coverage; drop obsolete fixHomeBreadcrumbs](https://github.com/nlemoine/page-for-custom-post-type/pull/19) on [nlemoine/page-for-custom-post-type](https://github.com/nlemoine/page-for-custom-post-type) — 3 weeks ago

### 🤝 Recent contributions
- [MilliPress/MilliCache](https://github.com/MilliPress/MilliCache) — 1 commit — 1 day ago
- [timber/timber](https://github.com/timber/timber) — 55 commits — 1 week ago
...
- [janreges/siteone-crawler](https://github.com/janreges/siteone-crawler) — 1 commit — 2 months ago
...
- [symfony/symfony](https://github.com/symfony/symfony) — ⭐ 31084 · 1 commit
- [unocss/unocss](https://github.com/unocss/unocss) — ⭐ 18853 · 1 commit
- [rjsf-team/react-jsonschema-form](https://github.com/rjsf-team/react-jsonschema-form) — ⭐ 15809 · 3 commits
- [Intervention/image](https://github.com/Intervention/image) — ⭐ 14348 · 3 commits
- [deployphp/deployer](https://github.com/deployphp/deployer) — ⭐ 11078 · 1 commit
...
- [gordalina/cachetool](https://github.com/gordalina/cachetool) — ⭐ 1817 · 4 commits
...
- [janreges/siteone-crawler](https://github.com/janreges/siteone-crawler) — ⭐ 774 · 1 commit
...
- [terrazzoapp/terrazzo](https://github.com/terrazzoapp/terrazzo) — ⭐ 410 · 4 commits

<sub>Auto-generated with <a href="https://github.com/nlemoine/packages/tree/main/packages/octofolio">octofolio</a> · last updated 2026-06-22</sub>
