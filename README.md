...
#### WordPress
- [wp-cli-move](https://github.com/nlemoine/wp-cli-move) ([v0.1.3](https://github.com/nlemoine/wp-cli-move/releases/tag/0.1.3) - 3 weeks ago) — Sync your WordPress content (database and uploads) between stages using the power of WP-CLI aliases.
- [wp-symfony-local-server](https://github.com/nlemoine/wp-symfony-local-server) ([v2.0.1](https://github.com/nlemoine/wp-symfony-local-server/releases/tag/v2.0.1) - 4 weeks ago) — A set a hooks to fix running WordPress on Symfony Local Server with local domain names
...
- [http-cli](https://github.com/nlemoine/http-cli) ([v1.1.1](https://github.com/nlemoine/http-cli/releases/tag/1.1.1) - 3 weeks ago) — Serverless HTTP client - make requests to PHP scripts on the command line
- [dtcg-tokens](https://github.com/nlemoine/dtcg-tokens) ([v1.0.0](https://github.com/nlemoine/dtcg-tokens/releases/tag/1.0.0) - 3 weeks ago) — Read, resolve, and render DTCG design tokens at runtime in PHP, with optional Twig and Symfony bridges.
...
- [feat: support multisite installations](https://github.com/nlemoine/wp-cli-move/pull/8) on [nlemoine/wp-cli-move](https://github.com/nlemoine/wp-cli-move) — 4 weeks ago
...
- [Intervention/image](https://github.com/Intervention/image) — 4 commits — 2 weeks ago
...
- [alleyinteractive/mantle-framework](https://github.com/alleyinteractive/mantle-framework) — 2 commits — 4 weeks ago
...
- [unocss/unocss](https://github.com/unocss/unocss) — ⭐ 18861 · 1 commit
- [rjsf-team/react-jsonschema-form](https://github.com/rjsf-team/react-jsonschema-form) — ⭐ 15819 · 3 commits
- [Intervention/image](https://github.com/Intervention/image) — ⭐ 14351 · 4 commits
...
- [Yoast/wordpress-seo](https://github.com/Yoast/wordpress-seo) — ⭐ 1969 · 4 commits
...
- [janreges/siteone-crawler](https://github.com/janreges/siteone-crawler) — ⭐ 788 · 1 commit
...
- [terrazzoapp/terrazzo](https://github.com/terrazzoapp/terrazzo) — ⭐ 418 · 4 commits

<sub>Auto-generated with <a href="https://github.com/nlemoine/packages/tree/main/packages/octofolio">octofolio</a> · last updated 2026-07-06</sub>
