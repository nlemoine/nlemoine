...
- [wp-symfony-local-server](https://github.com/nlemoine/wp-symfony-local-server) ([v2.0.1](https://github.com/nlemoine/wp-symfony-local-server/releases/tag/v2.0.1) - 3 months ago) — A set a hooks to fix running WordPress on Symfony Local Server with local domain names
...
#### PHP
- [dtcg-tokens](https://github.com/nlemoine/dtcg-tokens) ([v2.0.1](https://github.com/nlemoine/dtcg-tokens/releases/tag/2.0.1) - 6 days ago) — Read, resolve, and render DTCG design tokens at runtime in PHP, with optional Twig and Symfony bridges.
...
- [fix(modifiers): keep the colorspace of the source in grayscale](https://github.com/Intervention/image-driver-vips/pull/122) on [Intervention/image-driver-vips](https://github.com/Intervention/image-driver-vips) — 1 day ago
- [Orient every frame of an animated Imagick image](https://github.com/Intervention/image/pull/1519) on [Intervention/image](https://github.com/Intervention/image) — 3 days ago
- [Detach Imagick frame when converting to image](https://github.com/Intervention/image/pull/1518) on [Intervention/image](https://github.com/Intervention/image) — 4 days ago
- [fix(modifiers): convert pixel data in ColorspaceModifier](https://github.com/Intervention/image-driver-vips/pull/121) on [Intervention/image-driver-vips](https://github.com/Intervention/image-driver-vips) — 4 days ago
- [Apply Imagick colorspace change to every frame](https://github.com/Intervention/image/pull/1517) on [Intervention/image](https://github.com/Intervention/image) — 4 days ago
- [fix(modifiers): keep the trimmed area when a later corner matches it](https://github.com/Intervention/image-driver-vips/pull/120) on [Intervention/image-driver-vips](https://github.com/Intervention/image-driver-vips) — 4 days ago
- [Fix Imagick grayscale flattening saturated colors](https://github.com/Intervention/image/pull/1516) on [Intervention/image](https://github.com/Intervention/image) — 4 days ago
- [fix: tie the cache key version to the released version](https://github.com/nlemoine/dtcg-tokens/pull/6) on [nlemoine/dtcg-tokens](https://github.com/nlemoine/dtcg-tokens) — 6 days ago
...
- [Intervention/image-driver-vips](https://github.com/Intervention/image-driver-vips) — 21 commits — 1 day ago
- [Intervention/image](https://github.com/Intervention/image) — 9 commits — 1 day ago
...
- [symfony/symfony](https://github.com/symfony/symfony) — ⭐ 31134 · 1 commit
- [unocss/unocss](https://github.com/unocss/unocss) — ⭐ 18939 · 1 commit
- [rjsf-team/react-jsonschema-form](https://github.com/rjsf-team/react-jsonschema-form) — ⭐ 15875 · 3 commits
- [Intervention/image](https://github.com/Intervention/image) — ⭐ 14365 · 9 commits
...
- [thephpleague/glide](https://github.com/thephpleague/glide) — ⭐ 2632 · 2 commits
...
- [janreges/siteone-crawler](https://github.com/janreges/siteone-crawler) — ⭐ 876 · 1 commit
...
<sub>Auto-generated with <a href="https://github.com/nlemoine/packages/tree/main/packages/octofolio">octofolio</a> · last updated 2026-08-26</sub>
